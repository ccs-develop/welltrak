...
namespace welltrack.iOS
{
	public class IconHelper
	{
		...
		{
			return ImageFromFont(text, iconColor, UIColor.Clear, iconSize, fontName);
		}

		public static UIImage ImageFromFont(string text, UIColor iconColor, UIColor backgroundColor , CGSize iconSize,
											string fontName = "fontawesome")
		{
